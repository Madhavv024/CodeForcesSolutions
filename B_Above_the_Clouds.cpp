...
/*
   Problem Statement
    ...
    b is substring of a + c

    check if a b c exist and non-empty
        
        b is substring of a and c, b = a;


        aba, abca, abcda --> NO
        aaa, aab, abba, 

        why aba is no and aab is yes

        a and c should be unique
            
            will sorting help? NO
...
void solve() {
    ...
    for(int i = 1;i<n-1;i++) if(cnt[s[i] - 'a']>1){
        cout<<"Yes\n";
        return;
    }
    cout<<"No\n";
