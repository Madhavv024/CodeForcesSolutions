...
void solve() {
    ...
    // for(int i = 1;i<n-1;i++){
    //     if((s[i]=='0' && s[i-1]=='1' && s[i+1]=='1') || (s[0]=='0' && s[1]=='1')
    //     || (s[n-2]=='1' && s[n-1]=='0') ){
        //         return;
        //     }
        // }
    
    iota(ans.begin(),ans.end(), 1); // filling all the values in ans from 1 to ans-end in increasing order
