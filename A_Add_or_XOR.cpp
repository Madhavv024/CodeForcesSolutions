...
/*
   Problem Statement
       we have 2 diff nums a , b
       want to make them equal--
        two op-> 1 a = a+1
                 2 a = a^1
        
        XOR ->  diff bits set to 1 and same set to 0

        check possibility
        if possible give min cost
*/
...
/*
   Small Observations
        ...
        when is impossible
            when a is even and target is less than a ||
                a is odd and target is less than a - 2
